...
const FooterBot = () => {
  ...
  return (
    <div className={` border-none ${theme ? "border-[#000]" : ""} `}>
      <div
      ...
      >
        <div
          className={` ${
            theme ? "border-[#000]" : ""
          } border-r relative pt-[40px] pb-[200px] z-10 `}
        >
        ...
        <div className="grid grid-cols-2 pt-[40px] pl-[30px] pb-[50px] justify-between">
          <ul className=" flex flex-col gap-2 ">
            ...
            <li className=" hover:text-[#fe977e] cursor-pointer ">Company</li>
            <li className=" hover:text-[#fe977e] cursor-pointer ">Portfolio</li>
            <li className=" hover:text-[#fe977e] cursor-pointer ">
              Partnership
            </li>
            <li className=" hover:text-[#fe977e] cursor-pointer ">Newsroom</li>
            <li className=" hover:text-[#fe977e] cursor-pointer ">Media kit</li>
            <li className=" hover:text-[#fe977e] cursor-pointer ">Careers</li>
            <li className=" hover:text-[#fe977e] cursor-pointer ">Contact</li>
          </ul>
        ...
        <div className="pb-[50px] ">
          <div className="grid grid-cols-2 justify-between pt-[40px] pl-[30px] pb-[50px]">
            <ul>
              ...
              <li className=" hover:text-[#fe977e] cursor-pointer ">X</li>
              <li className=" hover:text-[#fe977e] cursor-pointer ">YouTube</li>
            </ul>
            <ul>
              <li className=" hover:text-[#fe977e] cursor-pointer ">
                +998 45039485-92{" "}
